...
/**
 * @file
 * Onehouse_base module file for template related functions.
 */
 ...
 */
function onehouse_base_theme_suggestions_webform_element_document_file_alter(array &$suggestions, array &$variables) {
  $fragments = [];
 ...
 */
function onehouse_base_theme_suggestions_alter(array &$suggestions, array &$variables, $hook) {
  $exclude = [
 ...
 */
function onehouse_base_theme($existing, $type, $theme, $path) {
  return [
 ...
 */
function onehouse_base_options_list_alter(array &$options, array $context) {
